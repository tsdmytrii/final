                ...
                $(this).validate({
                    ...
                    messages: {
                        name: {
                            ...
                            '<button data-dismiss="alert" class="close" type="button">&times;</button>' +
                            "Task name must be shorter than 100 symbols!" + '</div>' 
                        },
                        deadlineDate: {
                            required: '<div class="alert alert-error fade in">' +
                            '<button data-dismiss="alert" class="close" type="button">&times;</button>' +
                            "Enter deadline date, please!" + '</div>',
                            DateFormat: '<div class="alert alert-error fade in">' +
                            '<button data-dismiss="alert" class="close" type="button">&times;</button>' +
                            "Please enter a date in the format yyyy/mm/dd" + '</div>' 
                        }
                    },
